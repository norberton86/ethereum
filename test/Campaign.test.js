...
beforeEach( async ()=>{
    ...
    await factory.methods.createCampaign('100'). //minimun contributium is 100 wei
    send({
        from:accounts[0],
        gas:'1000000'
    })
...
describe('Campaigns',()=>{
    ...
    it('deploys a factory in the campaign',()=>{
    ...
    it('allows people to contribute money and mark them as contributors',async ()=>{
        ...
        try{
            await campaign.methods.contribute().send({
                value:'5', //we use value instead to gas because the function is using 'payable'                 
                from:accounts[1]
            });
